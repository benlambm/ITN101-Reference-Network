...
This GitHub repository is the knowledge base for the ITN 101 (Introduction to Network Concepts) labs at Brightpoint Community College, VCCS. It contains Sample/reference device configurations, IP addressing plan, standard operational procedures(SOPs), sample policies and change-management demos for a small 3-tier enterprise network with Router redundancy. Everything here mirrors the documentation practices used in real-world IT organizations.
---
...
- **VCCS ITN Curriculum**: ITN101 Introduction to Network Concepts
