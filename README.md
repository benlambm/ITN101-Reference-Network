...
This repository is the knowledge base for the ITN 101 (Introduction to Network Concepts) labs at Brightpoint Community College, VCCS. It contains Sample/reference device configurations, IP addressing plan, operational procedures, governance policies, and change-management records for a 3-tier enterprise network with HSRP redundancy. Everything here mirrors the documentation practices used in real-world IT organizations.
---
